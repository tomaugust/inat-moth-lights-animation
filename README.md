...
The project builds on the visual design and animation engine developed in [tomaugust/moth-lights-animation](https://github.com/tomaugust/moth-lights-animation). See that original repository for details of how the canvas animation, moth movement, interactions and audio work.
